        ...
        <div style="border-radius:0; " class="modal-dialog">
            <div class="modal-content">
                <div style="background-color:#4285F4; color:white" class="modal-header">
                    ...
                    <h4 class="modal-title" id="memberModalLabel">Editar <?php echo $row['marca']?></h4>
                </div>
                            ...
                            <div class="col-xs-12">
                                <div <?php echo $style ?> >
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input id="revision" class="login_input form-control" type="text"  name="marca"  required value="<?php echo $row['marca'] ?>"  />
                ...
                <div class="modal-footer">
                    ...
                    <input  type="submit" name="edit_marca" class="btn btn-primary btn-flat" value="Guardar">
