        ...
        <div style="border-radius:0; " class="modal-dialog">
            <div class="modal-content">
                <div style="background-color:red; color:white" class="modal-header">
                    ...
                    <h4 class="modal-title" id="memberModalLabel">Eliminar <?php echo $row['categoria']?></h4>
                </div>
                            ...
                            <div class="col-xs-12">
                                <div <?php echo $style ?> >
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input id="revision" class="login_input form-control" type="text"  name="categoria" value="<?php echo $row['categoria'] ?>" disabled  />
                ...
                <div class="modal-footer">
                    ...
                    <input  type="submit" name="delete_categoria" class="btn btn-danger btn-flat" value="Eliminar">
